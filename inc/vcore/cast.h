...
//#define CObject         BaseObj
//#define CRuntimeClass   Class
#define ASSERT          VX_ASSERT
//#define RUNTIME_CLASS   CLASS_
...
// or reference.  These macros only work for CObjects.  In retail code, they
...
// unsafe casts are used for CObject-derived classes.
//
// NOTE: Calls to ISA_() will still result in a CRuntimeClass structure 
...
// {
//		DECLARE_DYNAMIC (Foo);			// in .h file (Foo declaration)
//      ...
// };
//
// IMPLEMENT_DYNAMIC (Foo, CObject);	// in .cpp file (Foo implementation)
//    
// void Foo::FooMethod (CObject* objPtr, CObject& objRef)
// {
...
#define ISA_(cls)				IsKindOf (RUNTIME_CLASS(cls))
#define ISCLASS_(cls)			GetClass() == (RUNTIME_CLASS(cls))
