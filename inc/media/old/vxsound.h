 ...
 * within the scene. Because VXSoundListenerBase inherits from Engine, 
...
class VXSoundListenerBase : public Engine
{
public:
/*
...
protected: 
	Vec3		m_UpOrientation, m_ForwardOrientation, m_Position, m_Velocity;
	int32		m_Environment;
	int32		m_Format;
 ...
 * inherits from Engine, each sound can have a target object and so 
 ...
 * @endcode
 */
class VXSoundSourceBase : public Engine
{
public:
/*
 *	Constructors and Destructors
