...
public:
	...
	int				GetUserID() const				{ return m_UserIndex; }
	...
	virtual void	OnLostUser(int userid);
...
protected:
	User&			GetUser(int i)					{ return m_Users[i - 1]; }
	...
	int				m_UserIndex;						// index of user being tracked
