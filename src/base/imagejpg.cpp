...
{
public:
	Core::Stream*	file_handle;	/* source stream */
...
{
public:
	Core::Stream*	file_handle;	/* destination stream */
	JOCTET*			buffer;			/* start of buffer */
};
...
void* ReadJPGFile(Bitmap* bmap, Core::Stream* stream)
{
...
#if 0
static bool WriteJPGFile(FILE* handle, int quality)
{
